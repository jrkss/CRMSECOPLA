...
function FormAprobaciones(props) {
    ...
    const baseUrlG = `https://localhost:7239/api/kds_aprobaciones/${match.params.partida}`;
    ...
    const getApiDataFormLev = async () => {
        const response = await fetch(baseUrlG).then(response => {
            ...
            .then(res => {
                ...
                console.log(res)
                const basformlev = `https://localhost:7239/api/formlevantamiento/${res.planta}`;
        ...
        <>
            <Formik
                ...
                onSubmit={(valores) => {
                    ...
                    const urlAprobaciones = `https://localhost:7239/api/kds_aprobaciones/${data.partida}`
                    const urlProEco = 'https://localhost:7239/api/kds_propuestaeconomica';
                    var fechahoy = (`${year}-${month}-${day}`);
                    var folcot =  (`${day}${month}${year}${hour}${minuts}`);
                    const dataApro = {
