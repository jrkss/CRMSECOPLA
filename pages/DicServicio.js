...
function DicServicio(props) {
  ...
  const mvformdicserv = (partida) => {
    props.history.push("/FormDicServ/" + partida);
  };
  const mvDescargas = () => {
      ...
      renderCell: (params) => {
        return (
          <Button
            ...
            onClick={(data) => mvformdicserv(params.row.partida)}
          ></Button>
        );
      },
    },
        ...
        <AppBar component="nav">
          <Toolbar sx={{ background: "#F1F6F9" }}>
            ...
            <Box sx={{ display: { xs: "none", sm: "block" } }}>
              ...
              <Button
                variant="text"
                onClick={() => mvAprobaciones()}
                startIcon={<AssignmentIndIcon />}
                sx={{ margin: "5px", color: "#394867", borderColor: "#fff" }}
              >
                APROBACIONES
              </Button>
              <Button
              ...
              <Button
                ...
                startIcon={<AdsClickIcon />}
                onClick={() => mvDescargas()}
                sx={{ margin: "5px", color: "gray", borderColor: "black" }}
              >
                DESCARGAS
              </Button>
            </Box>
