...
function FormDicServ(props) {
  ...
  const [kdspropeco, setKdsProEco] = useState([]);

  var plantaid = kdspropeco.planta;
  ...
  const ApiGetKdsProEco = () => {
    const urlkdsproeco = `https://localhost:7239/api/kds_propuestaeconomica/${match.params.planta}`;

    const response = fetch(urlkdsproeco)
      .then((response) => {
      ...
      .then((data) => {
        ...
        const urlkdsproeco = `http://192.168.1.47:5000/api/formlevantamiento/${data.planta}`;
  ...
  const ApiGetAreasProspectos = () => {
    ...
    const areasResponse = fetch(baseAreasPG)
      .then((areasResponse) => {
  ...
  const ApiGetCinturones = () => {
    ...
    const cinturonResponse = fetch(baseCinturonG)
      .then((cinturonResponse) => {
  ...
  const ApiGetServicios = () => {
    ...
    const serviciosResponse = fetch(baseServiciosG)
  ...
  const ApiGetProductRNP = () => {
    ...
    const productrnpResponse = fetch(baseproductrnpG)
      .then((productrnpResponse) => {
  ...
  const ApiGetServiciosTrampasDispositivos = () => {
    const baseservtramdispG =
      "https://localhost:7239/api/serviciostrampasdispositivos";

    const servtramdispResponse = fetch(baseservtramdispG)
      .then((servtramdispResponse) => {
  ...
  const ApiGetFrecuencia = () => {
    ...
    const frecuenciaResponse = fetch(basefrecuenciaG)
      .then((frecuenciaResponse) => {
    ...
    <div>
      ...
      <Formik
        ...
        onSubmit={(valores) => {
          ...
          const urltabfour = "https://localhost:7239/api/proecotabfour";
          const urltabfive = "https://localhost:7239/api/proecotabfive";
          const urldatagrid = `http://192.168.1.47:5000/api/kds_propuestaeconomica/${match.params.planta}`;
          ...
          try {
            ...
            for (let i = 0; i < serviceList.length; i++) {
              ...
              if (
                valores.pe_taba_apli != "" &&
                valores.pe_taba_prod != "" &&
                valores.pe_taba_cant != ""
              ) {
                const insertabtwo = axios
                  .post(urltabtwo, datatabtwo)
                  .then((res) => {
                    if (res.status === 200 || res.status === 201) {
                      for (let j = 0; j < equipoList.length; j++) {
                        ...
                        if (
                          valores.pe_tabb_equip != "" &&
                          valores.pe_tabb_cant != "" &&
                          valores.pe_tabb_prod != ""
                        ) {
                          const insertabthree = axios
                            .post(urltabthree, datatabthree)
                            .then((res) => {
                              if (res.status === 200 || res.status === 201) {
                      ...
                      if (
                        valores.pe_ae_acomodato != "" &&
                        valores.pe_ae_procliente != "" &&
                        valores.pe_ec_fisica != ""
                      ) {
                        const insertabone = axios
                          .post(urltabone, datatabone)
                          .then((res) => {
                            if (res.status === 200 || res.status === 201) {
                              for (let i = 0; i < servadicList.length; i++) {
                                const datatabfour = {
                                  planta: data.planta,
                                  id_prospecto: data.id_prospecto,
                                  pe_tabc_servadic:
                                    servadicList[i].pe_tabc_servadic,
                                  pe_tabc_cantmen:
                                    servadicList[i].pe_tabc_cantmen,
                                  pe_tabc_espe: servadicList[i].pe_tabc_espe,
                                };
                                const inserttabfour = axios
                                  .post(urltabfour, datatabfour)
                                  .then((res) => {
                                    if (
                                      res.status === 200 ||
                                      res.status === 201
                                      ...
                                      for (
                                        let i = 0;
                                        i < reqadicList.length;
                                        i++
                                      ) {
                                        const datatabfive = {
                                          planta: data.planta,
                                          id_prospecto: data.id_prospecto,
                                          pe_tabd_solicitud: reqadicList[i].pe_tabd_solicitud,
                                          pe_tabd_yesno: reqadicList[i].pe_tabd_yesno,
                                          pe_tabd_espe: reqadicList[i].pe_tabd_espe,
                                        };
                                        const inserttabfive = axios
                                          .post(urltabfive, datatabfive)
                                          .then((res) => {
                                            if (
                                              res.status === 200 ||
                                              res.status === 201
                                              ...
                                              const datapropuestaeconomica = {
                                                partida: kdspropeco.partida,
                                                planta: kdspropeco.planta,
                                                id_prospecto:
                                                  kdspropeco.id_prospecto,
                                                proeco_nombre:
                                                  kdspropeco.proeco_nombre,
                                                proeco_asesor:
                                                  kdspropeco.proeco_asesor,
                                                proeco_fecha: fechahoy,
                                                proeco_estatus: "Cerrado",
                                              };

                                              const update = axios
                                                .put(
                                                  urldatagrid,
                                                  datapropuestaeconomica
                                                )
                                                .then((res) => {
                                                  if (
                                                    res.status === 200 ||
              ...
              <TapPanel value={value} index={0}>
                ...
                >
                  ...
                  <Item sx={{ width: "33.33%", height: "auto" }}>
                    ...
                    <br />
                    <Typography>Propiedad del cliente:</Typography>
                  </Item>
                  <Item sx={{ width: "33.33%", height: "auto" }}>
                    {" "}
                    <div>
                ...
                <div className="apliequiforms">
                  <div className="formtdataae">
                    <div className="titleapli">
                      <label>APLICACIONES</label>
                    </div>

                    <div className="titleequi">
                      <label>EQUIPOS</label>
                    </div>
                  </div>
                          ...
                          {serviceList.map((singleService, index) => (
                            <div key={index} className="services">
                              <div className="datagridone">
                                ...
                                >
                                  {servicio.map((dat) => (
                                    <MenuItem key={dat.c1} value={dat.c1}>
                                      {dat.c2}
                                    </MenuItem>
                                  ))}
                                </Select>
                              ...
                              <div className="datagridfour">
                                ...
                                >
                                  {areasprospecto.map((dat) => (
                                    <MenuItem key={dat.c1} value={dat.c3}>
                                      {dat.c3}
                                    </MenuItem>
                                  ))}
                                </Select>
                            ...
                            <div key={indexe} className="services">
                              <div className="datagridBone">
                                <Select
                                  ...
                                  onChange={(e) => {
                                    handleEquipoChange(e, indexe);
                                    handleChange(e);
                                  }}
                                  required
                                >
                                  {servtrampdisp.map((dat) => (
                                    <MenuItem key={dat.c1} value={dat.c2}>
                                      {dat.c2}
                                    </MenuItem>
                                  ))}
                                </Select>
                              ...
                              <div className="datagridBeight">
                                {equipoList.length !== 1 && (
                                  <IconButton
                                    onClick={() => handleEquipoRemove(indexe)}
                                    aria-label="delete"
                                    color="error"
                                  >
                                    <DeleteIcon />
                              ...
                              {equipoList.length - 1 === indexe &&
                                equipoList.length < 100 && (
                                  <Button
                                    type="button"
                      ...
                      {servadicList.map((singleServAdic, indexa) => (
                        <div key={indexa} className="services">
                          <div className="datagridCone">
                            <TextField
                              className="inputformdise"
                              name="pe_tabc_servadic"
                              type="text"
                              id="pe_tabc_servadic"
                              placeholder="Agregar Equipo"
                              value={singleServAdic.pe_tabc_servadic}
                              onChange={(e) => {
                                handleServAdicChange(e, indexa);
                                handleChange(e);
                              }}
                              required
                            />
                          ...
                          <div className="datagridCtwo">
                            <TextField
                              className="inputformdise"
                              name="pe_tabc_cantmen"
                              type="text"
                              id="pe_tabc_cantmen"
                              placeholder="Agregar Cantidad"
                              value={singleServAdic.pe_tabc_cantmen}
                              onChange={(e) => {
                                handleServAdicChange(e, indexa);
                                handleChange(e);
                              }}
                          ...
                          <div className="datagridCthree">
                            <TextField
                              ...
                              value={singleServAdic.pe_tabc_espe}
                              onChange={(e) => {
                                handleServAdicChange(e, indexa);
                                handleChange(e);
                              }}
                          ...
                          <div className="datagridCfour">
                            {servadicList.length !== 1 && (
                              <IconButton
                                onClick={() => handleServAdicRemove(indexa)}
                                aria-label="delete"
                                color="error"
                              >
                                <DeleteIcon />
                  ...
                  {reqadicList.map((singleReqAdic, indexR) => (
                    <div key={indexR} className="services">
                      <div className="datagridCone">
                        <TextField
                          className="inputformdise"
                          name="pe_tabd_solicitud"
                          type="text"
                          id="pe_tabd_solicitud"
                          placeholder="Solicitud"
                          value={singleReqAdic.pe_tabd_solicitud}
                          onChange={(e) => {
                            handleReqAdicChange(e, indexR);
                            handleChange(e);
                          }}
                          required
                        />
                      ...
                      <div className="datagridCtwo">
                        <FormControl>
                          <RadioGroup
                            ...
                            onBlur={handleBlur}
                            value={singleReqAdic.pe_tabd_yesno}
                          >
                            <FormControlLabel
                              value="Si"
                              control={<Radio />}
                      ...
                      <div className="datagridCthree">
                        <TextField
                          ...
                          value={singleReqAdic.pe_tabd_espe}
                          onChange={(e) => {
                            handleReqAdicChange(e, indexR);
                            handleChange(e);
                          }}
                      ...
                      <div className="datagridCfour">
                        {reqadicList.length !== 1 && (
                          <IconButton
                            onClick={() => handleReqAdicRemove(indexR)}
                            aria-label="delete"
                            color="error"
                          >
                            <DeleteIcon />
                      ...
                      {reqadicList.length - 1 === indexR &&
                        reqadicList.length < 100 && (
                          <Button
                            type="button"
