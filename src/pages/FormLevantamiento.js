...
/*   const subirArchivos = e => {
    ...
    */
    ...
    const rows = [
        { nombre_contacto: data.nombre_contacto, nombre_empresa: data.nombre_empresa }
    ];
            ...
            <Formik
                ...
                initialValues={
                    {
                        ...
                        electrocutadores_requerdio: `${data.electrocutadores_requerdio|| '0'}`,
                        electrocutadores_comentarios: `${data.electrocutadores_comentarios || ''}`,
                        ...
                        tratamiento_mosca_requerido: `${data.tratamiento_mosca_requerido || '0'}`,
                        tratamiento_mosca_comentarios: `${data.tratamiento_mosca_comentarios || ''}`,
                        ...
                        distancia_tecnico_requerido: `${data.distancia_tecnico_requerido|| '0'}`,
                        distancia_tecnico_comentarios: `${data.dispensadores_comentarios || ''}`,
                        frecuencia_aspersion_actual: `${data.frecuencia_aspersion_actual|| '0'}`,
                        frecuencia_aspersion_requerido: `${data.frecuencia_aspersion_requerido|| '0'}`,
                        frecuencia_aspersion_comentarios: `${data.frecuencia_aspersion_comentarios || ''}`,
                        frecuencia_nebulizacion_actual: `${data.frecuencia_nebulizacion_actual|| '0'}`,
                        frecuencia_nebulizacion_requerido: `${data.frecuencia_nebulizacion_requerido|| '0'}`,
                        frecuencia_nebulizacion_comentaros: `${data.frecuencia_nebulizacion_comentaros || ''}`,
                        frecuencia_termo_actual: `${data.frecuencia_termo_actual|| '0'}`,
                        frecuencia_termo_requerido: `${data.frecuencia_termo_requerido|| '0'}`,
                        frecuencia_termo_comentarios: `${data.frecuencia_termo_comentarios || ''}`,
                        tratamiento_unidades_actual: `${data.tratamiento_unidades_actual|| '0'}`,
                        tratamiento_unidades_requerido: `${data.tratamiento_unidades_requerido|| '0'}`,
                        tratamiento_unidades_comentarios: `${data.tratamiento_unidades_comentarios || ''}`,
                        tratamiento_tarimas_actual: `${data.tratamiento_tarimas_actual || '0'}`,
                        tratamiento_tarimas_requerido: `${data.tratamiento_tarimas_requerido || '0'}`,
                        tratamiento_tarimas_comentarios: `${data.tratamiento_tarimas_comentarios || ''}`,
                        equipo_comodato_actual: `${data.equipo_comodato_actual|| '0'}`,
                        equipo_comodato_requerido: `${data.equipo_comodato_requerido|| '0'}`,
                        equipo_comodato_comentarios: `${data.equipo_comodato_comentarios || ''}`,
                        ...
                        tratamiento_drenaje_actual: `${data.tratamiento_drenaje_actual|| '0'}`,
                        tratamiento_drenaje_requerido: `${data.tratamiento_drenaje_requerido|| '0'}`,
                        tratamiento_drenaje_comentarios: `${data.tratamiento_drenaje_comentarios || ''}`,
                        malla: `${data.malla || ''}`,
                        pared: `${data.pared || ''}`,
                ...
                onSubmit={(valores) => {
                    const editaFormLev = {
                        ...
                        tratamiento_mosca_comentarios: valores.tratamiento_mosca_comentarios,
                        ...
                        distancia_tecnico_comentarios: valores.distancia_tecnico_comentarios,
                        frecuencia_aspersion_actual: valores.frecuencia_aspersion_actual,
                        frecuencia_aspersion_requerido: valores.frecuencia_aspersion_requerido,
                        frecuencia_aspersion_comentarios: valores.frecuencia_aspersion_comentarios,
                        frecuencia_nebulizacion_actual: valores.frecuencia_nebulizacion_actual,
                        frecuencia_nebulizacion_requerido: valores.frecuencia_nebulizacion_requerido,
                        frecuencia_nebulizacion_comentaros: valores.frecuencia_nebulizacion_comentaros,
                        ...
                        tratamiento_unidades_requerido: valores.tratamiento_unidades_requerido,
                        tratamiento_unidades_comentarios: valores.tratamiento_unidades_comentarios,
                        tratamiento_tarimas_actual: valores.tratamiento_tarimas_actual,
                        tratamiento_tarimas_requerido: valores.tratamiento_tarimas_requerido,
                        tratamiento_tarimas_comentarios: valores.tratamiento_tarimas_comentarios,
                        ...
                        tratamiento_drenaje_requerido: valores.tratamiento_drenaje_requerido,
                        tratamiento_drenaje_comentarios: valores.tratamiento_drenaje_comentarios,
                        malla: valores.malla,
                        pared: valores.pared,
                    ...
                    try {
                        ...
                        const insercion = axios.put(urlEdita, editaFormLev).then(res => {
                            if (res.status === 200 || res.status === 201) {
                                ...
                                if (index === -1) {
                                    const insercionapro = axios.post(urlApro, dataapro).then(res => {
                                    });
                                } else {
                    ...
                    <div className="containerflevantamiento">
                        <form className="formulario" onSubmit={handleSubmit}>
                            ...
                            <Tabs
                                ...
                                onChange={handleTabs}
                            >
                                <Tab className="TabClass" label="DGE" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="REG" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="REC" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="REC" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="RPP" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="TEC" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="RCL" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="MAM" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="LOT" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="IEP" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="RIN" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />
                                <Tab className="TabClass" label="CFI" style={{ minWidth: "8.33%", maxWidth: "8.33%" }} />

                            </Tabs>
                            <TapPanel value={value} index={0}>
                                <div className="tdatgen"><label > DATOS GENERALES.</label></div>
                               ...
                               />*/}</div>
                                    ...
                                    <div><TextField sx={{ width: "80%", marginTop: "10px" }}
                            ...
                            <TapPanel value={value} index={1}>
                                <div className="treqgen"><label > REQUERIMIENTOS GENERALES.</label></div>
                                <div className="unolef">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Existen requerimientos en su programa de seguridad e higiene que deberíamos observar?</FormLabel>
                                        <RadioGroup row
                                    ...
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Existe algún requerimiento de la secretaría de salubridad de la localidad que deberíamos
                                            observar?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                ...
                                <div className="unoraigh">
                                    ...
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Qué normas sanitarias tienen que cumplir?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            onChange={handleChange}
                            ...
                            <div className="treqgen"><label>REQUERIMIENTOS ESPECÍFICOS DEL CLIENTE</label></div>
                                <div className="treslef">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label"> ¿Se identifico el tipo de plaga que pudiera generar un conflicto en planta?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            id='identifica_plaga'
                                    ...
                                    <label className="labelform">Si R=SI Especificar el tipo de plaga</label>
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Fauna Doméstica</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            id="fauna_domestica"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Fauna Silvestre</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Insectos Voladores</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Insectos Rastreros</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                ...
                                <div className="tresraigh">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Fauna Aviar</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="fauna_aviar"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿El problema de aves lo soucionamos con la desornitación o se requiere un plan especifico?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="desornitacion"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Gorgojo</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="gorgojo"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Roedores / Rata</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="roedores"
                            ...
                            <div className="treqgen"><label>REQUERIMIENTOS ESPECÍFICOS DEL CLIENTE</label></div>
                                <div className="cuatrolef">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Tiene identificadas las áreas conflictivas de la empresa en relación al control de plagas?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <label className="labelform">si R= SI Especifica el tipo de plaga.</label>
                                    <label className="labelform">Alguna de las siguientes zonas, tiene conflicto de Plaga </label>

                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Escaleras</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="escaleras"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Azoteas</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="azoteas"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Techos / Estructuras</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="techos"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Pasillos / Recepción.</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="pasillos"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Baños / Vestidores</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="banios"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Lockers</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="lockers"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Rampas</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="rampas"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Área de Producción</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Áreas Verdes / Estacionamiento / Vigilancia</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="areas_verdes"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Comedores / Cocina.</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="comedores"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Oficinas / Salas de Juntas</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="oficinas"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Almácen, Materías primas</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="almacen_mp"
                                ...
                                <div className="cuatroraigh">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Almácen, Producto Terminado</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="almacen_pt"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Almácen, Material de Empaque</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Planta Tratadora de Agua</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="tratadora_agua"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Contenedores de Basura</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Silos</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="silos"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Túneles Transportadores</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="tuneles"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Bandas Transportadoras</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="bandas_transportadora"
                                            id="bandas_transportadora"
                                            value={values.requebandas_transportadorarimiento_salubridad}
                                            onChange={handleChange}
                                            onBlur={handleBlur}
                                        >
                                            <FormControlLabel value="Si" control={<Radio />} label="Si" />
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Unidades de Reparto</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Tarimas</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="tarimas"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Talleres</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="talleres"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Camáras de Refrigeración</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Producto no Conforme / Devoluciones</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Otros, Especificar…</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Bajo qué lineamientos son auditados?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            ...
                                            onBlur={handleBlur}
                                        >
                                            <FormControlLabel value="AIB" control={<Radio />} label="AIB" />
                                            <FormControlLabel value="BRC" control={<Radio />} label="BRC" />
                                            <FormControlLabel value="SQF" control={<Radio />} label="SQF" />
                                            <FormControlLabel value="ISO" control={<Radio />} label="ISO" />
                            ...
                            <div className="treqgen"><label>RIESGOS Y PELIGROS EN PLANTA</label></div>
                                <div className="cincocontainer">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿El Personal que labora en Planta cuenta con programas de formación y desarrollo para el Manejo Integrado de Plagas?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue="" 
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Se cuenta con programas de Mantenimiento o Limpieza? (PLAN MAESTRO)</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Se cuenta con programas de pre-requisitos de almacenamiento de producto?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Las condiciones de INFRAESTRUCTURA, están diseñadas para el buen Manejo Integrado de Plagas?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                            ...
                            <div className="treqgen"><label>¿Los técnicos / instaladores deben de cumplir con requisitos específicos para su ingreso? Como los siguientes</label></div>
                                <div className="seislef">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Equipo de comunicación específico</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Equipo de protección personal</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="equipo_epp"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Procedimiento de acceso interno</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="acceso_interno"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Horarios específicos</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="horarios"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Exámenes médicos (¿Cuáles?)</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Frecuencia de exámenes</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Carta de antecedentes no penales</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                ...
                                <div className="seisrigth">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Afiliación al IMSS</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="imss"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Credenciales de identificación</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Existen días especificos para capacitación?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Capacitación por parte de la empresa</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Planeación de visitas (días específicos)</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">DC-3</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="dc3"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Hay alguna zona asignada a plagas para el resguardo de equipos?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                            ...
                            <div className="treqgen"><label>REQUERIMIENTOS COMERCIALES Y LEGALES</label></div>
                                <div className="sietelef">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Orden de compra</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="orden_compra"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Contrato / Propuesta Firmada</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="contrato"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Periodo del Servicio contratado.(Indicar la cantidad de meses del contrato)</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Entrega de Carpeta física</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="carpeta_fisica"
                                ...
                                <div className="sieteright">
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">Entrega de carpeta digital</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Se requiere el pago por uso de portal para factura?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="portal_factura"
                                    ...
                                    <br />
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Se requiere alguna fianza?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="fianza"
                            ...
                            <div className="treqgen"><label>MEDIO AMBIENTE</label></div>
                                <div className='ochocontainer'>
                                    <FormLabel id="demo-radio-buttons-group-label">¿Cuál es la estacionalidad de plagas de la región?</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name="plagas_region"
                                        ...
                                        variant="filled" />
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">Colindancia (Frente, Posterior, Izquierda, Derecha, Arriba de, Debajo de)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name="colindancia"
                            ...
                            <div className="treqgen"><label>LAY OUT / MEDIDAS</label></div>

                                <div className='nuevecontainer'>
                                    <FormControl>
                                        <FormLabel id="demo-radio-buttons-group-label">¿Lay Out proporcionado por el cliente?</FormLabel>
                                        <RadioGroup row
                                            aria-labelledby="demo-radio-buttons-group-label"
                                            defaultValue=""
                                            name="layout_cliente"
                                    ...
                                    <a href={data.urlimagen} target="_blank"
                                        style={{ width: "80%", marginTop: "10px", fontSize:'20px'}}
                                    >URL Image
                                    </a>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                            ...
                            <div className="treqgen"><label>INFORMACIÓN PARA ELABORAR PROPUESTA</label></div>

                                <div className="diezlef">
                                    <FormLabel id="demo-radio-buttons-group-label">Cebaderos A</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    />
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">Cebaderos B</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    />
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">Mecanicas C</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        label="Metalicas"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">T-REX</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name='trex_actual'
                                        id='trex_actual'
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Gomas para roedor</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Gomas para insecto rastrero</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Electrocutadores</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Dispensadores</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                ...
                                <div className="diezmid">
                                    <FormLabel id="demo-radio-buttons-group-label">Jaulas (indicar especie)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name='jaulas_actual'
                                        id='jaulas_actual'
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Bebederos (indicar especie)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Feromonas (Indicar tipo y si incluye Domo)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Tratamiento para Mosca.(Cubeta / Bolsa) (indicar periodo de cambio de atrayente)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Otros (indicar producto)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name='otros_actual'
                                        id='otros_actual'
                                    ...
                                    />
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">¿Se requiere técnico Fijo?. (Indicar horario y jornada)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    />
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">Salario del técnico de zona. (Revisar con RH)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Frecuencia de visita Técnico de Ruta</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Distancia (en km) entre el técnico más cercano y las instalaciones del cliente (Revisar con Operaciones)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                ...
                                <div className="diezright">
                                    ...
                                    <FormLabel id="demo-radio-buttons-group-label">Frecuencia de Aspersiones(Indicar m2 de las zonas a aplicar)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Frecuencia de Nebulizaciones (Indicar m3 de las zonas a aplicar)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Frecuencia de Termonebulizaciones(Indicar m3 de las zonas a aplicar)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Tratamiento a Unidades.(Especificar total, tipo de Unidades, frecuencia y tipo aplicación a realizar)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Tratamiento a Tarimas.(Especificar total de tarimas, frecuencia y tipo aplicación)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Equipos a comodato</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Equipos propiedad del cliente</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        ...
                                        variant="filled"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Tratamiento a drenajes (indicar frecuencia)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                            ...
                            <div className="treqgen"><label>REQUERIMIENTOS PARA INSTALACIONES</label></div>

                                <div className="oncelef">
                                    <FormLabel id="demo-radio-buttons-group-label">Cantidad de Localizadores</FormLabel>
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">En malla</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name='malla'
                                        id='malla'
                                        ...
                                        label="En Malla"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">En pared</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                        name='pared'
                                        id='pared'
                                        ...
                                        label=" En Pared"
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Varillas para anclar</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                ...
                                <div className="oncemid">
                                    <FormLabel id="demo-radio-buttons-group-label">Especificaciones para Instalar</FormLabel>
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">Tipo de Superficie.(Indicar si es, tierra, concreto, etc)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                    ...
                                    /><br />
                                    <FormLabel id="demo-radio-buttons-group-label">Tipo de Instalación.(Indicar la forma de ancar los equipos)</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                                ...
                                <div className="onceright">
                                    <FormLabel id="demo-radio-buttons-group-label">Datos Proveedor Actual</FormLabel>
                                    <br />
                                    <FormLabel id="demo-radio-buttons-group-label">Proveedor Actual</FormLabel>
                                    <br />
                                    <TextField sx={{ width: "80%", marginTop: "10px" }}
                            ...
                            <div className="treqgen"><label>COMENTARIOS</label></div>

                                <div className="docecontainer">
                                    <FormLabel id="demo-radio-buttons-group-label" style={{ width: '20px' }}>Indicar información de reelevancia a considerar para complementar el levantamiento (pertenece a un grupo, tiene plantas o unidades de servicio adicionales, es un cliente al que ya le damos servicio, es recomendación de un cliente actual, etc)</FormLabel>
                                    <br /><TextField sx={{ width: "80%", marginTop: "10px" }}
